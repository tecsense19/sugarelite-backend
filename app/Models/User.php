...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'username', 'user_role', 'avatar_url', 'sex', 'height', 'premium', 'age', 'weight', 'country', 'sugar_type', 'birthdate', 'email', 'password', 'region',  'bio', 'ethnicity', 'body_structure', 'hair_color', 'piercings', 'tattoos', 'education', 'smoking', 'drinks', 'employment', 'civil_status','user_status', 'confirmed_email', 'online', 'last_online', 'last_activity_at', 'created_at', 'updated_at', 'deleted_at', 'subscription_stop_date', 'subscription_resume_date'
    ];
